...
public class DriverClass {
    ...
    // hdfs.copyFromLocalFile(new Path("/Users/anmol/HadoopConnect/Employee.csv"),new Path("hdfs://localhost:9000/"));
     //   hdfs.copyFromLocalFile(new Path("/Users/anmol/HadoopConnect/Building.csv"),new Path("hdfs://localhost:9000/"));
